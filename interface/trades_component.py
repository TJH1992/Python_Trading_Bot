...
class TradesWatch(tk.Frame):
    def __init__(self, *args, **kwargs):
        ...
        self._headers = ["time", "symbol", "exchnage", "strategy", "side", "quantity", "status", "pnl"]
    ...
    def add_trade(self, trade: Trade):
        ...
        dt_str = datetime.datetiem.fromtimestamp(trade.time / 1000).strftime("%b %d %H:%M")
        ...
        self.body_widgets['exchange'][t_index] = tk.Label(self._table_frame, text=trade.contract.eschange.capitalize(),
