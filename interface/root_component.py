            ...
            try:
                ...
                for b_index, strat in client.strategies.items():
                    ...
                    for trade in strat.trades:
                        ...
                        self._trade_frame.body_widgets['status_var'][trade.time].set(trade.status.capiltalize())
        ...
        try:
            for key, value in self._watchlist_frame.body_widgets['symbol'].items():
                ...
                if prices['bid'] is not None:
                    ...
                    self._watchlist_frame.body_widgets['bid_var'][key].set(prices[price_str])

                if prices['ask'] is not None:
                    price_str = "{0:.{prec}f}".format(prices['ask'], prec=precision)
                    self._watchlist_frame.body_widgets['ask_var'][key].set(prices[price_str])
