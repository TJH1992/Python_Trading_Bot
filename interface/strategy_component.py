    ...
    def __init__(self, *args, **kwargs):
        ...
        self._base_params = [
            {"code_name": "strategy_type", "widget": tk.OptionMenu, "data_type": str,
             "value": ["Tecnical", "Breakout"], "width": 10},
            {"code_name": "contract", "widget": tk.OptionMenu, "data_type": str, "value": self._all_contracts,
             "width": 15},
            {"code_name": "timeframe", "widget": tk.OptionMenu, "data_type": str, "value": self._all_timeframes,
             "width": 7},
        ...
        for h in self._base_params:
            self.body_widgets[h['code_names']] = dict()
